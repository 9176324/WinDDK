...
void __stdcall
        _com_raise_error(__in HRESULT hr, __in_opt IErrorInfo* perrinfo = 0) throw(_com_error);

#ifndef _INC_COMUTIL
void __stdcall
        _com_issue_error(__in HRESULT) throw(_com_error);
#endif

void __stdcall
        _com_issue_errorex(__in HRESULT, __in IUnknown*, __in REFIID) throw(_com_error);

HRESULT __stdcall
        _com_dispatch_propget(__in IDispatch*, __in DISPID, __in VARTYPE, __in void*) throw(_com_error);
HRESULT __cdecl
        _com_dispatch_propput(__in IDispatch*, __in DISPID,__in  VARTYPE, ...) throw(_com_error);
HRESULT __cdecl
        _com_dispatch_method(__in IDispatch*, __in DISPID, __in WORD,__in  VARTYPE, __in  void*,
                                                 __in  __drv_constant const wchar_t*, ...) throw(_com_error);

HRESULT __stdcall
        _com_dispatch_raw_propget(__in IDispatch*, __in DISPID, __in VARTYPE, __in void*) throw();
HRESULT __cdecl
        _com_dispatch_raw_propput(__in IDispatch*, __in DISPID, __in VARTYPE, ...) throw();
HRESULT __cdecl
        _com_dispatch_raw_method(__in IDispatch*, __in DISPID, __in WORD, __in VARTYPE, __in void*,
                                                        __in __drv_constant const wchar_t*, ...) throw();
...
public:
        ...
        _com_error(__in HRESULT hr,
               __in_opt IErrorInfo* perrinfo = NULL,
               __in_opt bool fAddRef = false) throw();
        __drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
        _com_error(__in const _com_error& that) throw();
        ...
        // Assignment operator
        //
        _com_error& operator=(__in const _com_error& that) throw();
        ...
        static HRESULT WCodeToHRESULT(__in WORD wCode) throw();
        static WORD HRESULTToWCode(__in HRESULT hr) throw();
...
__drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
inline _com_error::_com_error(__in HRESULT hr,
                              __in_opt IErrorInfo* perrinfo,
                              __in_opt bool fAddRef) throw()
...
__drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
inline _com_error::_com_error(__in const _com_error& that) throw()
...
inline _com_error& _com_error::operator=(__in const _com_error& that) throw()
{
        if (this != &that) {
...
inline HRESULT _com_error::WCodeToHRESULT(__in WORD wCode) throw()
{
        return wCode >= 0xFE00 ? WCODE_HRESULT_LAST : WCODE_HRESULT_FIRST + wCode;
}

inline WORD _com_error::HRESULTToWCode(__in HRESULT hr) throw()
{
