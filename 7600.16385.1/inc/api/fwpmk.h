...
void NTAPI FwpmFreeMemory0(__inout void** p);
...
FwpmBfeStateSubscribeChanges0(
   ...
   __in FWPM_SERVICE_STATE_CHANGE_CALLBACK0 callback,
...
FwpmTransactionBegin0(
   __in __drv_acquiresResource(TxnLock)HANDLE engineHandle,
   __in UINT32 flags
   );
...
NTSTATUS
NTAPI
FwpmTransactionCommit0(__in __drv_releasesResource(TxnLock)HANDLE engineHandle);


__drv_maxIRQL(PASSIVE_LEVEL)
NTSTATUS
NTAPI
FwpmTransactionAbort0(__in __drv_releasesResource(TxnLock)HANDLE engineHandle);
