...
#define InMode 0x68
#define InServiceCount 0x70
#define InDispatchCount 0x74
...
#define PrProcessRegion 0x30
#define PrSessionMapInfo 0x40
#define PrSessionParentBase 0x48
#define PrThreadListHead 0x50
#define PrAffinity 0x68
#define PrReadyListHead 0x90
#define PrSwapListEntry 0xa0
#define PrActiveProcessors 0xa8
#define PrProcessFlags 0xd0
#define PrBasePriority 0xd4
#define PrQuantumReset 0xd5
#define PrCycleTime 0x118
#define PrKernelTime 0x120
#define PrUserTime 0x124
#define KernelProcessObjectLength 0x130
#define ExecutiveProcessObjectLength 0x4a0
...
#define PfSource 0x70
#define PfStarted 0x72
#define ProfileObjectLength 0x78
...
#define ThSize 0x2
#define ThLock 0x0
#define THREAD_FLAGS_CYCLE_PROFILING 0x2
#define THREAD_FLAGS_CYCLE_PROFILING_LOCK_BIT 0x11
#define THREAD_FLAGS_CYCLE_PROFILING_LOCK 0x20000
#define THREAD_FLAGS_COUNTER_PROFILING 0x4
#define THREAD_FLAGS_COUNTER_PROFILING_LOCK_BIT 0x12
#define THREAD_FLAGS_COUNTER_PROFILING_LOCK 0x40000
#define ThDebugActive 0x3
#define ThThreadControlFlags 0x2
#define THREAD_FLAGS_CPU_THROTTLED 0x1
#define THREAD_FLAGS_CPU_THROTTLED_BIT 0x0
#define THREAD_FLAGS_ACCOUNTING_ANY 0x5
...
#define DEBUG_ACTIVE_PRIMARY_THREAD 0x80
#define DEBUG_ACTIVE_PRIMARY_THREAD_BIT 0x7
#define DEBUG_ACTIVE_PRIMARY_THREAD_LOCK_BIT 0x1f
#define DEBUG_ACTIVE_SCHEDULED_THREAD 0x40
#define DEBUG_ACTIVE_SCHEDULED_THREAD_BIT 0x6
#define DEBUG_ACTIVE_SCHEDULED_THREAD_LOCK_BIT 0x1e
#define DEBUG_ACTIVE_SCHEDULED_THREAD_LOCK 0x40000000

#define KTHREAD_UMS_DIRECTED_SWITCH_ENABLE_BIT 0xb
#define KTHREAD_UMS_PERFORMING_SYSCALL_BIT 0x8

#define ThMiscFlags 0x4c
#define ThThreadFlags 0x118
#define ThWaitBlock 0x120
#define ThPreviousMode 0x20e
#define ThResourceIndex 0x299
#define ThLargeStack 0x2eb
#define ThQueueListEntry 0x1e0
#define ThTrapFrame 0x1f0
#define ThFirstArgument 0x1f8
#define ThCallbackStack 0x200
#define ThCallbackDepth 0x200
#define ThServiceTable 0x1c8
#define ThApcStateIndex 0x208
#define ThIdealProcessor 0x240
#define ThBasePriority 0x209
#define ThPriorityDecrement 0x20a
#define ThSaturation 0x20f
#define ThSystemCallNumber 0x210
#define ThUserAffinity 0x218
#define ThProcess 0x228
#define ThAffinity 0x230
#define ThApcStatePointer 0x248
#define ThSavedApcState 0x258
#define ThFreezeCount 0x214
#define ThSuspendCount 0x284
#define ThUserIdealProcessor 0x244
#define ThCallbackBStore 0x1d0
...
#define KernelThreadObjectLength 0x390
#define ExecutiveThreadObjectLength 0x4c8
...
#define UcTeb 0xa80
#define UcContext 0x10
#define UcFlags 0xa90
#define UcLink 0x0
#define UcContextLock 0xa98
#define UcPrimaryUmsContext 0xac0
#define UMSCTX_SCHEDULED_THREAD_MASK 0x1
#define UMSCTX_SCHEDULED_THREAD_BIT 0x0
#define UMSCTX_VOLATILE_CONTEXT_MASK 0x20
#define UMSCTX_VOLATILE_CONTEXT_BIT 0x5
#define UMSCTX_TERMINATED_MASK 0x40
#define UMSCTX_TERMINATED_BIT 0x6
#define UMSCTX_SUSPENDED_MASK 0x10
#define UMSCTX_SUSPENDED_BIT 0x4
#define UMSCTX_DEBUG_ACTIVE_MASK 0x80
#define UMSCTX_DEBUG_ACTIVE_BIT 0x7
#define UMSCTX_DENY_RUNNING_ON_SELF_THREAD_MASK 0x200
#define UMSCTX_DENY_RUNNING_ON_SELF_THREAD_BIT 0x9
...
#define ProcessEnvironmentBlockLength 0x380
...
#define PERF_SPINLOCK_OFFSET 0x4
#define PERF_SPINLOCK_FLAG 0x10000
...
#define ETW_SPINLOCK_BASIC 0x0
#define ETW_SPINLOCK_QUEUED 0x1
...
#define SerPoisonPageAddress 0xe8
...
#define PcNumber 0xb2c
#define PcKernelDebugActive 0xb32
#define PcCurrentIrql 0xb33
#define PcSoftwareInterruptPending 0xb34
#define PcApcInterrupt 0xb34
#define PcDispatchInterrupt 0xb35
#define PcIrqlMask 0x280
#define PcIrqlTable 0x2c0
#define PcGroupSetMember 0xb08
#define PcCurrentThread 0xb20
#define PcNotGroupMember 0xb10
#define PcSystemReserved 0x50
#define PcHalReserved 0x80
#define PcIvr 0xb68
#define PcInitialStack 0xb70
#define PcInitialBStore 0xb78
#define PcStackLimit 0xb80
#define PcBStoreLimit 0xb88
#define PcPanicStack 0xb90
#define PcSavedIIM 0xb98
#define PcSavedIFA 0xba0
#define PcFpbLock 0xba8
#define PcForwardProgressBuffer 0xbb0
#define PcEOITable 0xb38
#define PcInOsMca 0xb40
#define PcInOsInit 0xb41
#define PcInOsCmc 0xb42
#define PcInOsCpe 0xb43
#define PcOsMcaResourcePtr 0xb48
#define PcHighFpOwner 0xb60
#define PcInterruptionCount 0x4c
#define PcOsMcaResource 0xc80
#define PcOsInitResource 0xd70
#define PcOsMcaRecInfo 0x6a00
#define PcPrcbData 0xe80
#define PcAlternateStack 0xb58
#define MAX_NUMBER_OF_IHISTORY_RECORDS 0x80
#define ProcessorControlRegisterLength 0x6c00
#define UsTickCountMultiplier 0x4
#define UsInterruptTime 0x8
#define UsSystemTime 0x14
...
#define PbNumber 0x44
#define PbBuildType 0x22
#define PbGroupSetMember 0x28
...
#define PbPacketBarrier 0x1600
#define PbCurrentPacket 0x1680
#define PbTargetCount 0x1698
#define PbWorkerRoutine 0x16a0
#define PbBranchHistory 0x16b0
#define PbRequestSummary 0x1700
#define PbSignalDone 0x1708
#define PbDpcListHead 0x1a00
#define PbDpcLock 0x1a10
#define PbDpcCount 0x1a1c
#define PbDpcStack 0x1a40
#define PbMaximumDpcQueueDepth 0x1a48
#define PbDpcRequestRate 0x1a4c
#define PbMinimumDpcRate 0x1a50
#define PbDpcLastCount 0x1a54
#define PbDpcRoutineActive 0x1a5b
#define PbNormalDpcState 0x1a5c
#define PbQuantumEnd 0x1a59
#define PbAdjustDpcThreshold 0x1a68
#define PbStartCount 0x1a60
#define PbIdleSchedule 0x1a5a
#define PbDeferredReadyListHead 0x17a0
#define PbPrcbLock 0x1798
#define PbReadySummary 0x17a8
#define PbDispatcherReadyListHead 0x1800
#define PbSkipTick 0x3d00
#define PbSpinLockAcquireCount 0x5a80
#define PbSpinLockContentionCount 0x5a84
#define PbSpinLockSpinCount 0x5a88
#define ProcessorBlockLength 0x5b80
...
#define UchStackTop 0x10
#define UchStackSize 0x18
#define UchIntSpOffset 0x20
#define UchBStoreBottom 0x28
#define UchRsBspOffset 0x30
#define UchRsPFS 0x38
#define UchRsRNAT 0x40
#define UchBrRp 0x48
#define UchIntTeb 0x50
#define UchTrapFrame 0x60
#define UchExceptionFrame 0x68
#define UchFlags 0x58
#define KUMS_UCH_VOLATILE_BIT 0x0
#define UmsContextHeaderLength 0x80


//
// Aligned Affinity Structure Offset Definitions
//

#define AfsCpuSet 0x0
...
#define LpbLoadOrderListHead 0x10
#define LpbMemoryDescriptorListHead 0x20
#define LpbKernelStack 0x40
#define LpbPrcb 0x48
#define LpbProcess 0x50
#define LpbThread 0x58
#define LpbInterruptStack 0xc8
#define LpbPanicStack 0xd0
#define LpbMachineType 0xc0
#define LpbItrInfo 0x138
#define LpbDtrInfo 0x1f8
...
#define KSEG2_BASE 0xe0000000e0000000
...
#define KSEG4_LIMIT 0xa004000000000000
...
#define PDE_UTBASE 0x1fffffff80000000
#define PDE_KTBASE 0x80000000
#define PDE_STBASE 0x3fffffff80000000
...
#define BREAK_RESTORE_CONTROL 0x1c0030
...
//
// RtlBackoff definitions
//

#define RtlBackoffLength 0x4
#define BoDelay 0x0
