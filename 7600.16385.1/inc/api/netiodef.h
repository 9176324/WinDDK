...
TokenRingGetSourceRouteIndicator(
    __in CONST UNALIGNED DL_EUI48 *Source
    )
{
...
TokenRingSetSourceRouteIndicator(
    __out UNALIGNED DL_EUI48 *Source
    )
{
...
Ip4HeaderLengthInBytes(
    __in CONST UNALIGNED IPV4_HEADER *Header
    )
{
...
UINT16
Ip6FragmentOffset(
    __in CONST UNALIGNED IPV6_FRAGMENT_HEADER *Header
    )
{
...
NmrIsEqualNpiModuleId(
    __in PNPI_MODULEID ModuleId1,
    __in PNPI_MODULEID ModuleId2
    )
{
