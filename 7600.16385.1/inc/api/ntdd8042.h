...
BOOLEAN
(*PI8042_MOUSE_ISR) (
    __in  PVOID                   IsrContext,
    __in  PMOUSE_INPUT_DATA       CurrentInput,
    __in  POUTPUT_PACKET          CurrentOutput,
    __in  UCHAR                   StatusByte,
    __in  PUCHAR                  Byte,
    __inout PBOOLEAN              ContinueProcessing,
    __in  PMOUSE_STATE            MouseState,
    __in  PMOUSE_RESET_SUBSTATE   ResetSubState
);
...
(*PI8042_KEYBOARD_INITIALIZATION_ROUTINE) (
    __in PVOID                           InitializationContext,
    __in PVOID                           SynchFuncContext,
    __in PI8042_SYNCH_READ_PORT          ReadPort,
    __in PI8042_SYNCH_WRITE_PORT         WritePort,
    __out PBOOLEAN                       TurnTranslationOn
    );
...
(*PI8042_KEYBOARD_ISR) (
    __in PVOID                   IsrContext,
    __in PKEYBOARD_INPUT_DATA    CurrentInput,
    __in POUTPUT_PACKET          CurrentOutput,
    __in UCHAR                   StatusByte,
    __in PUCHAR                  Byte,
    __out PBOOLEAN                ContinueProcessing,
    __in PKEYBOARD_SCAN_STATE    ScanState
    );
