...
LONG __stdcall
PreUpgradeInitialize(__in  LPCTSTR         szWorkingDir,
                     __in  NetUpgradeInfo* pNetUpgradeInfo,
                     __out VENDORINFO*     pviVendorInfo,
                     __out DWORD*          pdwFlags,
                     __out NetUpgradeData* pNetUpgradeData);

typedef LONG
(__stdcall *PreUpgradeInitializePrototype)
     (__in  LPCTSTR         szWorkingDir,
      __in NetUpgradeInfo* pNetUpgradeInfo,
      __out VENDORINFO*     pviVendorInfo,
      __out DWORD*          pdwFlags,
      __out NetUpgradeData* pNetUpgradeData);
...
//
LONG __stdcall
DoPreUpgradeProcessing(__in   HWND        hParentWindow,
                       __in   HKEY        hkeyParams,
                       __in   LPCTSTR     szPreNT5InfId,
                       __in   LPCTSTR     szPreNT5Instance,
                       __in   LPCTSTR     szNT5InfId,
                       __in   LPCTSTR     szSectionName,
                       __out  VENDORINFO* pviVendorInfo,
                       __out  DWORD*      pdwFlags,
...
//
LONG __stdcall
DoPostUpgradeProcessing(__in  HWND    hParentWindow,
                        __in  HKEY    hkeyParams,
                        __in  LPCTSTR szPreNT5Instance,
                        __in  LPCTSTR szNT5InfId,
                        __in  HINF    hinfAnswerFile,
                        __in  LPCTSTR szSectionName,
                        __out VENDORINFO* pviVendorInfo,
                        __in  LPVOID  pvReserved);
...
__drv_preferredFunction("(see documentation)", "Obsolete") 
LONG __stdcall
NetUpgradeAddSection(__in LPCTSTR szSectionName);
...
__drv_preferredFunction("(see documentation)", "Obsolete") 
LONG __stdcall
NetUpgradeAddLineToSection(__in LPCTSTR szSectionName,
                           __in LPCTSTR szLine);
