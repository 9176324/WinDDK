...
typedef BOOL (APIENTRY *PFN_DrvGetDriverSetting)(
        PVOID                           pdriverobj,
        PCSTR                           Feature,
        __out_bcount_opt(cbSize) PVOID  pOutput,
        DWORD                           cbSize,
        __out_opt PDWORD                pcbNeeded,
        __out_opt PDWORD                pdwOptionsReturned
        );
...
OEMEnableDriver(
    ...
    DWORD                               cbSize,
    __out_bcount(cbSize) PDRVENABLEDATA pded
    );
...
typedef DWORD (APIENTRY *PFN_DrvWriteSpoolBuf)(
    PDEVOBJ                    pdevobj,
    __in_bcount(cbSize) PVOID  pBuffer,
    DWORD                      cbSize
    );
...
typedef BOOL (APIENTRY *PFN_DrvGetStandardVariable)(
    PDEVOBJ                        pdevobj,
    DWORD                          dwIndex,
    __out_bcount_opt(cbSize) PVOID pBuffer,
    DWORD                          cbSize,
    __out PDWORD                   pcbNeeded
    );
...
OEMEnablePDEV(
    ...
    ULONG                              cPatterns,
    __inout_ecount(cPatterns) HSURF    *phsurfPatterns,
    ULONG                              cjGdiInfo,
    __inout_bcount(cjGdiInfo) GDIINFO  *pGdiInfo,
    ULONG                              cjDevInfo,
    __inout_bcount(cjDevInfo) DEVINFO  *pDevInfo,
...
OEMCommand(
    PDEVOBJ                        pdevobj,
    DWORD                          dwIndex,
    __in_bcount_opt(cbSize) PVOID  pData,
    DWORD                          cbSize
    );
...
OEMCommandCallback(
    ...
    DWORD                           dwCallbackID,
    DWORD                           dwCount,
    __in_ecount_opt(dwCount) PDWORD pdwParams
    );
...
OEMCompression(
    PDEVOBJ                       pdevobj,
    __in_bcount(dwInLen) PBYTE    pInBuf,
    __out_bcount(dwOutLen) PBYTE  pOutBuf,
    DWORD                         dwInLen,
    DWORD                         dwOutLen
    );
...
OEMHalftonePattern(
    ...
    DWORD                                  dwCallbackID,
    __in_bcount_opt(dwResourceSize) PBYTE  pResource,
...
OEMMemoryUsage(
    PDEVOBJ                 pdevobj,
    __inout POEMMEMORYUSAGE pMemoryUsage
    );
...
OEMTTYGetInfo(
    PDEVOBJ                     pdevobj,
    DWORD                       dwInfoIndex,
    __out_bcount(dwSize) PVOID  pOutputBuf,
    DWORD                       dwSize,
    __out DWORD                 *pcbcNeeded
    );
...
OEMOutputCharStr(
    ...
    DWORD                       dwType,
    DWORD                       dwCount,
    __in_ecount(dwCount) PVOID  pGlyph
    );
...
OEMQueryColorProfile(
    ...
    PVOID                               pOEMDM,
    ULONG                               ulQueryMode,
    __out_bcount(*pcbProfileData) VOID  *pvProfileData,
