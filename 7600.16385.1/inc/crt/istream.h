...
public:
    ...
    istream& operator>>(__out_z_opt char *);
...
public:
    ...
    inline istream& get(__out_ecount_z(lim) char *,int lim,char ='\n');
    ...
    inline istream& getline(__out_ecount(_lim) char *,int lim,char ='\n');
    ...
    istream& read(__out_ecount(n) char *,int n);
...
protected:
    ...
    istream& get(__out_ecount_z(lim) char *, int lim, int);
     int do_ipfx(int);

private:
    istream(ios&);
    int getint(__out_ecount(MAXLONGSIZ) char *);
    int getdouble(__out_ecount(buflen) char *, int buflen);
    int _fGline;
    int x_gcount;
};
    ...
    inline istream& istream::get(__out_ecount(_lim)  char * _b, int _lim, char _delim) { return get(        _b, _lim, (int)(unsigned char)_delim); }
    ...
    inline istream& istream::getline(__out_ecount(_lim)  char * _b,int _lim,char _delim) { lock(); _fGline++; get(        _b, _lim, (int)(unsigned char)_delim); unlock(); return *this; }
