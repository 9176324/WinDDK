...
(*PCIP_VALIDATE_ROUTINE) (
    __in PCIP_VALIDATE_INFO ValidateInfo
    );
...
ULONG
(*PCIP_NOTIFY_ROUTINE) (
    __in PCIP_NOTIFY_INFO   NotifyInfo
    );
...
void
(*PCMP_NOTIFY_ROUTINE) (
    __in PCMP_NOTIFY_INFO   NotifyInfo
    );
...
(*PBUS_RESET_ROUTINE) (
    __in PVOID                  Context,
    __in PBUS_GENERATION_NODE   BusResetInfo
    );
...
(*PCMP_MONITOR_ROUTINE) (
    __in PCMP_MONITOR_INFO  MonitorInfo
    );
