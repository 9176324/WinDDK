...
typedef
__drv_functionClass(MF_ENUMERATE_CHILD)
NTSTATUS
MF_ENUMERATE_CHILD(
    __in_opt PVOID Context,
    __in ULONG Index,
    __out
        __drv_at(ChildInfo->Name.Buffer,         __drv_allocatesMem(Mem))
        __drv_at(ChildInfo->HardwareID.Buffer,   __drv_allocatesMem(Mem))
        __drv_at(ChildInfo->CompatibleID.Buffer, __drv_allocatesMem(Mem))
        __drv_at(ChildInfo->ResourceMap,         __drv_allocatesMem(Mem))
        __drv_at(ChildInfo->VaryingResourceMap,  __drv_allocatesMem(Mem))
