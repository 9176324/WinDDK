...
(*PSCSIWMI_QUERY_REGINFO) (
    ...
    __in PSCSIWMI_REQUEST_CONTEXT RequestContext,
...
(*PSCSIWMI_QUERY_DATABLOCK) (
    __in PVOID Context,
    __in PSCSIWMI_REQUEST_CONTEXT DispatchContext,
...
(*PSCSIWMI_EXECUTE_METHOD) (
    ...
    __inout_bcount_part(InBufferSize, OutBufferSize) PUCHAR Buffer
    );
/*++
...
(*PSCSIWMI_FUNCTION_CONTROL) (
    ...
    __in PSCSIWMI_REQUEST_CONTEXT RequestContext,
    __in ULONG GuidIndex,
    __in SCSIWMI_ENABLE_DISABLE_CONTROL Function,
    __in BOOLEAN Enable
    );
/*++
...
BOOLEAN
ScsiPortWmiDispatchFunction(
    __in PSCSI_WMILIB_CONTEXT WmiLibInfo,
