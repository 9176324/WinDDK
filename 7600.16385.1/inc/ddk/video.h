...
VideoPortAcquireSpinLock(
    __inout __deref __drv_acquiresExclusiveResource(VideoPortSpinLock) 
    PVOID HwDeviceExtension, 
    __in PSPIN_LOCK SpinLock,
    __out __deref __drv_savesIRQL PUCHAR OldIrql 
    );
...
VideoPortReleaseSpinLock(
    ...
    __inout __deref __drv_releasesExclusiveResource(VideoPortSpinLock) 
    PSPIN_LOCK SpinLock, 
    __in __drv_restoresIRQL UCHAR NewIrql
    );
