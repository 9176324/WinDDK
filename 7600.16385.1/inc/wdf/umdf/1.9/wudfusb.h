...
EXTERN_C const IID IID_IUsbTargetPipeContinuousReaderCallbackReadComplete;
    ...
    public:
        virtual void STDMETHODCALLTYPE OnReaderCompletion( 
            /* [annotation][in] */ 
            __in  IWDFUsbTargetPipe *pPipe,
            /* [annotation][in] */ 
            __in  IWDFMemory *pMemory,
            /* [annotation][in] */ 
...
EXTERN_C const IID IID_IWDFUsbTargetPipe2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE ConfigureContinuousReader( 
            ...
            /* [annotation][in] */ 
            __in  SIZE_T HeaderLength,
            /* [annotation][in] */ 
            __in  SIZE_T TrailerLength,
            /* [annotation][in] */ 
            __in  UCHAR NumPendingReads,
            /* [annotation][unique][in] */ 
            __in_opt  IUnknown *pMemoryCleanupCallbackInterface,
            /* [annotation][in] */ 
            __in  IUsbTargetPipeContinuousReaderCallbackReadComplete *pOnCompletion,
            /* [annotation][unique][in] */ 
            __in_opt  PVOID pCompletionContext,
            /* [annotation][unique][in] */ 
            __in_opt  IUsbTargetPipeContinuousReaderCallbackReadersFailed *pOnFailure) = 0;
    ...
    typedef struct IWDFUsbTargetPipe2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *ConfigureContinuousReader )( 
            ...
            __in_opt  PVOID pCompletionContext,
            /* [annotation][unique][in] */ 
            __in_opt  IUsbTargetPipeContinuousReaderCallbackReadersFailed *pOnFailure);
