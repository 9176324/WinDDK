...
void SetDlgControls (HWND hWnd, tAC97Features *pAC97Features)
{
    ...
    iRes = LoadString(ghInstance, IDS_PROP_NO, No, ARRAYSIZE(No));
    iRes = LoadString(ghInstance, IDS_PROP_NA, NA, ARRAYSIZE(NA));
    iRes = LoadString(ghInstance, IDS_PROP_18, R18, ARRAYSIZE(R18));
    iRes = LoadString(ghInstance, IDS_PROP_20, R20, ARRAYSIZE(R20));
