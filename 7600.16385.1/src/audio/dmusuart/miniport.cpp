...
NTSTATUS
CMiniportDMusUARTStream::
ConnectOutput(__in  PMXF sinkMXF)
{
    PAGED_CODE();
...
NTSTATUS
CMiniportDMusUARTStream::
DisconnectOutput(__in   PMXF sinkMXF)
{
    PAGED_CODE();
 ...
 * Timestamps will ascend by design.
 */
NTSTATUS CMiniportDMusUARTStream::PutMessage(__in   PDMUS_KERNEL_EVENT pDMKEvt)
{
    NTSTATUS            ntStatus = STATUS_SUCCESS;
    PDMUS_KERNEL_EVENT  aDMKEvt;
