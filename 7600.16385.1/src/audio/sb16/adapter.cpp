...
DWORD DeterminePlatform(PPORTTOPOLOGY Port)
{
    ...
    //
    //  Try for the exact release (Win98SE hotfix 3, WinME hotfix, Win2KSP2, WinXP, or later).
    //
    if (pPortClsVersion)
    {
...
#pragma prefast(suppress:28159, "FALSE positive from PFD for downlevel OS's")
        ...
        //
        //  TODO: Look for registry entries that denote WinME hotfixes
...
#pragma prefast(suppress:28159, "FALSE positive from PFD for downlevel OS's")
    ...
    if (pPortEvents)
    {
        dwVersion = kVersionWin98SE; // or older hotfixes
        //
        //  TODO: Look for registry entries that denote older Win98SE hotfixes
    ...
    //
    //  TODO: Look for registry entries that denote older Win98 hotfixes
    //  HKLM\Software\Microsoft\Windows\CurrentVersion\Setup\Updates\..., etc.
    //
