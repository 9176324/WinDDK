...
CdNormalizeFileNames (
    ...
    __in PVCB Vcb,
    __in BOOLEAN OpenByFileId,
    __in BOOLEAN IgnoreCase,
    __in TYPE_OF_OPEN RelatedTypeOfOpen,
    __in_opt PCCB RelatedCcb,
    __in_opt PUNICODE_STRING RelatedFileName,
    __inout PUNICODE_STRING FileName,
    __inout PCD_NAME RemainingName
    );
