...
#pragma prefast( suppress: 28107, "we were in the process of constructing the device object, by definition it is safe for us to destroy it")
...

{
    ...
    try {
        ...
        //
#pragma prefast( suppress: 28107, "prefast cannot work out that the FCB must already be acquired")
...
#pragma prefast( suppress: 28107, "prefast cannot work out that the VCB is acquired")
        CdReleaseVcb( IrpContext, Vcb );
