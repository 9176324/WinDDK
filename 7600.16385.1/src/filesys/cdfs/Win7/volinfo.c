...
CdQueryFsVolumeInfo (
    ...
    __in PVCB Vcb,
    __out PFILE_FS_VOLUME_INFORMATION Buffer,
...
CdQueryFsSizeInfo (
    __in PIRP_CONTEXT IrpContext,
    __in PVCB Vcb,
    __out PFILE_FS_SIZE_INFORMATION Buffer,
    __inout PULONG Length
    );
...
CdQueryFsDeviceInfo (
    __in PIRP_CONTEXT IrpContext,
    __in PVCB Vcb,
    __out PFILE_FS_DEVICE_INFORMATION Buffer,
    __inout PULONG Length
    );
...
CdQueryFsAttributeInfo (
    __in PIRP_CONTEXT IrpContext,
    __in PVCB Vcb,
    __out PFILE_FS_ATTRIBUTE_INFORMATION Buffer,
    __inout PULONG Length
    );
