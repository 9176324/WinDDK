...
//  is valid
//
//      ASSERT_STRUCT( __in PVOID Struct, __in CSHORT NodeType );
//      ASSERT_OPTIONAL_STRUCT( __in_opt PVOID Struct, __in CSHORT NodeType );
//
//      ASSERT_VCB( __in PVCB Vcb );
//      ASSERT_OPTIONAL_VCB( __in_opt PVCB Vcb );
//
//      ASSERT_FCB( __in PFCB Fcb );
//      ASSERT_OPTIONAL_FCB( __in_opt PFCB Fcb );
//
//      ASSERT_FCB_NONPAGED( __in PFCB_NONPAGED FcbNonpaged );
//      ASSERT_OPTIONAL_FCB( __in_opt PFCB_NONPAGED FcbNonpaged );
//
//      ASSERT_CCB( __in PSCB Ccb );
//      ASSERT_OPTIONAL_CCB( __in_opt PSCB Ccb );
//
//      ASSERT_IRP_CONTEXT( __in PIRP_CONTEXT IrpContext );
//      ASSERT_OPTIONAL_IRP_CONTEXT( __in_opt PIRP_CONTEXT IrpContext );
//
//      ASSERT_IRP( __in PIRP Irp );
//      ASSERT_OPTIONAL_IRP( __in_opt PIRP Irp );
//
//      ASSERT_FILE_OBJECT( __in PFILE_OBJECT FileObject );
//      ASSERT_OPTIONAL_FILE_OBJECT( __in_opt PFILE_OBJECT FileObject );
//
//  The following macros are used to check the current thread owns
//  the indicated resource
//
//      ASSERT_EXCLUSIVE_RESOURCE( __in PERESOURCE Resource );
//
//      ASSERT_SHARED_RESOURCE( __in PERESOURCE Resource );
//
//      ASSERT_RESOURCE_NOT_MINE( __in PERESOURCE Resource );
//
...
//
//      ASSERT_EXCLUSIVE_VCB( __in PVCB Vcb );
//
//      ASSERT_SHARED_VCB( __in PVCB Vcb );
//
//      ASSERT_EXCLUSIVE_FCB( __in PFCB Fcb );
//
//      ASSERT_SHARED_FCB( __in PFCB Fcb );
//
//      ASSERT_EXCLUSIVE_FILE( __in PFCB Fcb );
//
//      ASSERT_SHARED_FILE( __in PFCB Fcb );
//
//      ASSERT_LOCKED_VCB( __in PVCB Vcb );
//
//      ASSERT_NOT_LOCKED_VCB( __in PVCB Vcb );
//
//      ASSERT_LOCKED_FCB( __in PFCB Fcb );
//
//      ASSERT_NOT_LOCKED_FCB( __in PFCB Fcb );
//
