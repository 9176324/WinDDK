...
KSERVICE_ROUTINE NICInterruptHandler;
...
DRIVER_LIST_CONTROL NICProcessSGList;

IO_DPC_ROUTINE NICDpcForIsr;
...
KDEFERRED_ROUTINE NICWatchDogTimerDpc;
...
IO_WORKITEM_ROUTINE NICAllocRfdWorkItem;

IO_WORKITEM_ROUTINE NICFreeRfdWorkItem;
