...
ReportToString(
   PHID_DATA    pData,
   __inout_bcount(iBuffSize) LPSTR szBuff,
   UINT          iBuffSize
);
        ...
        case WM_DEVICECHANGE:
            switch (wParam) 
            {
                ...
                case DBT_DEVICEREMOVECOMPLETE:
                    ...
                    {
                        PDEV_BROADCAST_HANDLE broadcastHandle;
                        PDEVICE_LIST_NODE     headNode, currNode;
                        HANDLE                deviceHandle;
                        ...
                        headNode = (PDEVICE_LIST_NODE) GetListHead(&PhysicalDeviceList);
                        ...
                        do
                        {
                            ...
                            else if(currNode -> HidDeviceInfo.HidDevice == deviceHandle)
                            {
                                //
                                // Found the node
                                //
