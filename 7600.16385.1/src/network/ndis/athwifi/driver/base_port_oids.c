...
BasePortQueryInterruptModerationSettings(
    ...
    __range(sizeof(NDIS_INTERRUPT_MODERATION_PARAMETERS), ULONG_MAX) ULONG InformationBufferLength
    )
{
...
BasePortQueryLinkParameters(
    __in  PMP_PORT                Port,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(NDIS_LINK_PARAMETERS), ULONG_MAX) ULONG InformationBufferLength
    )
{
    NDIS_STATUS                 ndisStatus = NDIS_STATUS_SUCCESS;
...
BasePortQueryDataRateMappingTable(
    __in  PMP_PORT                Port,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_DATA_RATE_MAPPING_TABLE), ULONG_MAX) ULONG InformationBufferLength,
...
BasePortQuerySupportedRXAntenna(
    __in  PMP_PORT                Port,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_SUPPORTED_ANTENNA_LIST), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
BasePortQueryDiversitySelectionRX(
    __in  PMP_PORT                Port,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_DIVERSITY_SELECTION_RX_LIST), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
BasePortQueryRegDomainsSupportValue(
    __in  PMP_PORT                Port,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_REG_DOMAINS_SUPPORT_VALUE), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
