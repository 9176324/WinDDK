...
HelperPortRequestExclusiveAccess(
    ...
    __in  PORT11_GENERIC_CALLBACK_FUNC CallbackFunction,
    __in  PVOID                 Context,
    __in  BOOLEAN               PnPOperation
    )
{
...
HelperPortFreeNdisPort(
    __in  PMP_PORT                HelperPort,
    __in  NDIS_PORT_NUMBER        PortNumberToFree
    )
{
    NDIS_STATUS                 ndisStatus;
    ...
    MPASSERT(ndisStatus == NDIS_STATUS_SUCCESS);
    __analysis_assume( ndisStatus == NDIS_STATUS_SUCCESS );
...
HelperPortActivateNdisPort(
    __in  PMP_PORT                HelperPort,
    __in  NDIS_PORT_NUMBER        PortNumberToActivate
    )
{
    NDIS_STATUS                 ndisStatus = NDIS_STATUS_SUCCESS;
...
HelperPortDeactivateNdisPort(
    __in  PMP_PORT                HelperPort,
    __in  NDIS_PORT_NUMBER        PortNumberToDeactivate
    )
{
    NDIS_STATUS                 ndisStatus = NDIS_STATUS_SUCCESS;
    NET_PNP_EVENT_NOTIFICATION  netPnpEventNotification;
