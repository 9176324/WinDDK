    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_AVAILABLE_CHANNEL_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_AVAILABLE_FREQUENCY_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_SSID_LIST) <= InformationBufferLength );
...
ApOidQueryStatistics(
    __in PMP_EXTAP_PORT ApPort,
    __out_bcount_part(InformationBufferLength, *BytesWritten) PVOID InformationBuffer,
    __in __range(sizeof(DOT11_STATISTICS), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG BytesWritten,
    __out PULONG BytesNeeded
    )
{
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_PRIVACY_EXEMPTION_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_AUTH_ALGORITHM_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_CIPHER_ALGORITHM_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_PEER_INFO_LIST) <= InformationBufferLength );
    ...
    )
{
    ...
    __analysis_assume( sizeof(DOT11_PHY_ID_LIST) <= InformationBufferLength );
...
ApOidQueryAdditionalIe(
    __in PMP_EXTAP_PORT ApPort,
    __out_bcount_part(InformationBufferLength, *BytesWritten) PVOID InformationBuffer,
    __in __range(sizeof(DOT11_ADDITIONAL_IE), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG BytesWritten,
    __out PULONG BytesNeeded    
    )
{
