...
StaQueryActivePhyList(
    ...
    __range(sizeof(DOT11_PHY_ID_LIST), ULONG_MAX) ULONG InformationBufferLength,
...
StaQueryDesiredBSSIDList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_BSSID_LIST) - sizeof(DOT11_MAC_ADDRESS), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryDesiredPhyList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_PHY_ID_LIST) - sizeof(ULONG), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryDesiredSsidList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_SSID_LIST) - sizeof(DOT11_SSID), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryEnabledAuthenticationAlgorithm(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_AUTH_ALGORITHM_LIST) - sizeof(DOT11_AUTH_ALGORITHM), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryEnabledMulticastCipherAlgorithm(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_CIPHER_ALGORITHM_LIST) - sizeof(DOT11_CIPHER_ALGORITHM), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQuerySupportedMulticastAlgorithmPair(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_AUTH_CIPHER_PAIR_LIST) - sizeof(DOT11_AUTH_CIPHER_PAIR), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaEnumerateAssociationInformation(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_ASSOCIATION_INFO_LIST), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryExcludedMACAddressList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_MAC_ADDRESS_LIST) - sizeof(DOT11_MAC_ADDRESS), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryIBSSParameters(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_IBSS_PARAMS), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryAssociationParameters(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_ASSOCIATION_PARAMS), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryPMKIDList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range(sizeof(DOT11_PMKID_LIST) - sizeof(DOT11_PMKID_ENTRY), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
...
StaQueryPrivacyExemptionList(
    __in  PMP_EXTSTA_PORT         Station,
    __out_bcount(InformationBufferLength) PVOID  InformationBuffer,
    __range((sizeof(DOT11_PRIVACY_EXEMPTION_LIST) - sizeof(DOT11_PRIVACY_EXEMPTION)), ULONG_MAX) ULONG InformationBufferLength,
    __out PULONG                  BytesWritten,
    __out PULONG                  BytesNeeded
    )
{
    ...
    )
{
    ...
    //
    if (VNic11CCMPImplemented(vnic) || VNic11TKIPImplemented(vnic))
    {
        if (config->BSSType == dot11_BSS_type_infrastructure)
        {
            config->AuthAlgorithm = DOT11_AUTH_ALGO_RSNA;
        }
        else if (VNic11CCMPImplemented(vnic))
        {
        ...
        *BytesNeeded = FIELD_OFFSET(DOT11_CIPHER_DEFAULT_KEY_VALUE, ucKey) + 
        ...
        switch (defaultKey->AlgorithmId)
        {
            case DOT11_CIPHER_ALGO_CCMP:
                if (!VNic11CCMPImplemented(STA_GET_VNIC(Station)))
                    ndisStatus = NDIS_STATUS_INVALID_DATA;
    ...
    )
{
    ...
    BOOLEAN                     CCMPImplemented = VNic11CCMPImplemented(STA_GET_VNIC(Station));
