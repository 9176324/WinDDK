...
MpDebugMatchPacketType(
    __in_bcount(sizeof(DOT11_DATA_LONG_HEADER))  PUCHAR                  PacketHeader,
    __in  UCHAR                   Type,
    __in  UCHAR                   SubType,
    __in_bcount(DOT11_ADDRESS_SIZE)  PDOT11_MAC_ADDRESS      DestinationAddress,
    __in_bcount(DOT11_ADDRESS_SIZE)  PDOT11_MAC_ADDRESS      SourceAddress
    );
...
#define MPASSERTOP(_Op)                         ASSERT(_Op)
