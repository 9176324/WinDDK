    ...
    if (*Status != NDIS_STATUS_SUCCESS)
    {
        ...
        if (pAdapt != NULL)
        {
            ...
            if (pAdapt->BindingHandle != NULL)
            {
                ...
                // 
                PtCloseAdapter(&LocalStatus, pAdapt);
...
Routine Description:
    ...
    Call either when the protocol is unbinding or the miniport is halting
...
--*/
{
    ...
    do
    {
        DBGPRINT(MUX_LOUD, ("BootStrapElans: Starting ELANs on adapter %p\n", pAdapt));
