                ...
                if ( lResult == ERROR_SUCCESS ) {
                    ...
                    while ( wcslen(lpMiniport) ) {
                        ...
                        if ( lpMiniportGuid != NULL ) {
                            ...
                            #pragma prefast(suppress:28197, "pMiniport is saved using m_MiniportList.Insert( pMiniport,guidMiniport ) and released using m_MiniportList.Remove in the destructor")
