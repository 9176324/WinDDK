...
#define HW_BUS_INTERFACE_TYPE                                   NdisInterfaceUSB 
...
#define HW_MAX_TX_MSDUS           5 // For USB we allocate 5 max TX MSDU's 
/** Default number of Tx MSDUs to allocate and initialize miniport with */
#define HW_DEF_TX_MSDUS           5 // For USB we allocate 5 max TX MSDU's
