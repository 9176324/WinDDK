...
#define TX_MSDU_BUFFER_SIZE             0XE0 // 224
...
#define RCB_BUFFER_SIZE                 2400 // 0x5F0
...
//--------------------------------------------------------------------------
// Interrupt Mitigation Equates
//--------------------------------------------------------------------------
#define	INT_MITG_MAX_COUNT				16
#define	TOK_PER_INT						2
#define	INTMITG_SCALE					10

#define	INTMITG_FLAG_TX					0x01
#define	INTMITG_FLAG_RX					0x02
#define	INTMITG_FLAG_MAX				0x03

#define	IMTMITG_METHOD_SEAN1			0x00
#define	INTMITG_METHOD_ANDY1			0x01
#define	INTMITG_METHOD_MAX				0x01
//--------------------------------------------------------------------------
//    Equates Added for NDIS 4
//--------------------------------------------------------------------------
#define  NUM_BYTES_PROTOCOL_RESERVED_SECTION    16
#define  MAX_NUM_ALLOCATED_RX_MSDUS              64
#define  MIN_NUM_RX_MSDU                         4
...
#define  MAC_RESERVED_SWRXMSDUPTR                0
#define  MAX_PACKETS_TO_ADD                     32


//-------------------------------------------------------------------------
//	Equates for Beacon queue
//-------------------------------------------------------------------------
#define NUM_BEACON_BUFFERS						2
#define NUM_BEACON_TX_MSDUS						1
#define NUM_BEACON_DESCS						2
