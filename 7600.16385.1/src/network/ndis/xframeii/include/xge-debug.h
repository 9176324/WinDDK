 ...
 * @XGE_COMPONENT_HAL_MM:	activate debug for memory related oparetions		
 * @	XGE_COMPONENT_HAL_QUEUE: activate debug for queue oparetions
 * @XGE_COMPONENT_HAL_INTERRUPT: activate debug for interrupt handling
 * @XGE_COMPONENT_HAL_STATS: activate debug for statistics oparetions 
...
static inline void xge_debug_interrupt(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_stats(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_queue(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_mm(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_config(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_fifo(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_ring(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_channel(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_device(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_hal(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_osdep(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
static inline void xge_debug_ll(xge_debug_level_e level, __in __format_string char *fmt, ...) {}
...
#define xge_assert(test) { \
	    if (!(test)) xge_os_bug("Assertion: "#test" at %s:%d\n", \
	__FILE__, __LINE__); }
#else
#define xge_assert(test)
