...
#define XGE_HAL_SERR_SOURCE_ANY     (XGE_HAL_SERR_SOURCE_PIC   | \
	...
	u64 pci_info;                                                   // NK- not found in hw spec
...
#define XGE_HAL_MDIO_INT_REG_LASI                      BIT(39)
	...
	u64 iic_int_reg;                                                                        // NK- IIC ones not found in hw spec
	u64 iic_int_mask;
...
#define XGE_HAL_MDIO_WARN_POUTPUTLOW        0x0001
	...
	u64 i2c_control;                                                                            // NK - not found in hw spec
...
/* TxDMA arbiter */
	u64 tx_dma_wrap_stat;                               // nk- not found in hw spec
...
/* Recent add, used only debug purposes. */
	...
	u64 txdma_debug_ctrl;                       // nk- not found in hw spec
...
#define XGE_HAL_RING_BUMP_CNT(i, val) (u16)(val >> (48 - (16 * (i % 4))))
	...
	u64 rxdma_debug_ctrl;                           // nk- not found in hw spec
...
#define XGE_HAL_RMAC_ERR_LEN_MISMATCH_ACCEPT    BIT(3)
	...
	u64 rmac_cfg_key;                               // nk - not found in hw spec
...
#define XGE_HAL_MAC_LINK_UTIL_DISABLE (XGE_HAL_MAC_TX_LINK_UTIL_DISABLE | \
	...
	u64 rmac_invalid_ipg;                   // nk - not found in hw spec
...
#define XGE_HAL_RTH_STATUS_SPDM_USE_L4             BIT(3)
	...
	u64 mac_debug_ctrl;                     // nk - not found in hw spec
...
#define XGE_HAL_MC_RLDRAM_MRS_ENABLE        BIT(47)
	...
	u64 mc_rldram_interleave;                           // nk - not found in hw spec
	...
	u64 mc_rldram_ref_per;                          // nk - not found in hw spec
	u8 unused21[0x220 - 0x208];
	u64 mc_rldram_test_ctrl;                        // nk - not found in hw spec    
...
#define XGE_HAL_MC_RLDRAM_TEST_PASS     BIT(31)
	...
	u64 mc_rldram_test_add;                     // nk - not found in hw spec
	u8 unused23[0x260 - 0x248];
	u64 mc_rldram_test_d0;                       // nk - not found in hw spec        
	u8 unused24[0x280 - 0x268];
	u64 mc_rldram_test_d1;                     // nk - not found in hw spec
	u8 unused25[0x300 - 0x288];
	u64 mc_rldram_test_d2;                     // nk - not found in hw spec
	u8  unused26_1[0x2C00 - 0x2B08];
	u64 mc_rldram_test_read_d0;                     // nk - not found in hw spec
	u8  unused26_2[0x20 - 0x8];
	u64 mc_rldram_test_read_d1;                     // nk - not found in hw spec
	u8  unused26_3[0x40 - 0x28];
	u64 mc_rldram_test_read_d2;                     // nk - not found in hw spec
	u8  unused26_4[0x60 - 0x48];
	u64 mc_rldram_test_add_bkg;                     // nk - not found in hw spec
	u8  unused26_5[0x80 - 0x68];
	u64 mc_rldram_test_d0_bkg;                     // nk - not found in hw spec
	u8  unused26_6[0xD00 - 0xC88];    
	u64 mc_rldram_test_d1_bkg;                     // nk - not found in hw spec
	u8  unused26_7[0x20 - 0x8];
	u64 mc_rldram_test_d2_bkg;                     // nk - not found in hw spec
	u8  unused26_8[0x40 - 0x28];
	u64 mc_rldram_test_read_d0_bkg;                     // nk - not found in hw spec
	u8  unused26_9[0x60 - 0x48];
	u64 mc_rldram_test_read_d1_bkg;                     // nk - not found in hw spec
	u8  unused26_10[0x80 - 0x68];
	u64 mc_rldram_test_read_d2_bkg;                     // nk - not found in hw spec
	u8  unused26_11[0xE00 - 0xD88];
	u64 mc_rldram_generation;                     // nk - not found in hw spec
	u8  unused26_12[0x20 - 0x8];
	u64 mc_driver;                     // nk - not found in hw spec
	u8  unused26_13[0x40 - 0x28];
	u64 mc_rldram_ref_per_herc;                     // nk - not found in hw spec
#define XGE_HAL_MC_RLDRAM_SET_REF_PERIOD(n)   vBIT(n, 0, 16)
	u8 unused26_14[0x660 - 0x648];
	u64 mc_rldram_mrs_herc;                     // nk - not found in hw spec
#define XGE_HAL_MC_RLDRAM_MRS(n)              vBIT(n, 14, 17)
	u8 unused26_15[0x700 - 0x668];
	u64 mc_debug_ctrl;                     // nk - not found in hw spec
...
#define XGE_HAL_RXGXS_RX_SM_ERR             BIT(39)
	...
	u64 xgxs_cfg_key;                        // nk - not found in hw spec
	u64 xgxs_efifo_cfg; /* CHANGED */       
	u64 rxgxs_ber_0;    /* CHANGED */                            // nk - not found in hw spec
	u64 rxgxs_ber_1;    /* CHANGED */                            // nk - not found in hw spec
