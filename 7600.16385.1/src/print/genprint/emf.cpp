...
BOOL GdiGetDevmodeForPagePvt(
    ...
    __deref_out     PDEVMODEW           *ppCurrDM,
    __deref_out_opt PDEVMODEW           *ppLastDM
  );
...
GetStartPageListForwardForDriver(
    ...
    __deref_out_opt PPAGE_NUMBER          *ppMemoryHead,
    __deref_out_opt PPAGE_NUMBER          *ppPageListHead,
...
PlayEMFPage(
    ...
    __in       HDC                   hPrinterDC,
    __in       HANDLE                hEMF,
    __in const PEMF_ATTRIBUTE_INFO   pEMFAttr,
...
CopyDevmode(
    __in            PPRINTPROCESSORDATA pData,
    __deref_out_opt LPDEVMODEW         *pDevmode)
...
ExtractScalingFactorFromAttributeInfo(
        __in     const PATTRIBUTE_INFO_4 pAttributeInfo,
        __inout  PEMF_ATTRIBUTE_INFO   pEMFAttr
        )
{
