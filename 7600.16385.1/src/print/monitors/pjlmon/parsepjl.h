...
typedef struct parseVarsTag
   ...
   __field_ecount(nTokenLeft) TokenPairType *pToken_Local;
   DWORD        dwNextToken;
   DWORD        dwFoundIndex;
   DWORD        status;
...
extern DWORD GetPJLTokens(__in LPSTR lpInPJL, DWORD nTokenInBuffer,
   __out_ecount(nTokenInBuffer) TokenPairType *pToken, __out DWORD *pnTokenParsed, __out LPSTR *plpInPJL);
