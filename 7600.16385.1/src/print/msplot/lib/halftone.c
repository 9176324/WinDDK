...
/* 
    To enable selectable halftone patterns for monochrome 
    printers, Yc should be set to VALID_YC in the 
    DefDevHTInfo structure.
*/
...
DEVHTINFO    DefDevHTInfo = {
...

        {
            ...
            { 2000, 2450,        0 },       // xc, yc, Yc Y=0=HT default
                                            //            Yc=VALID_YC=Selectable patterns 
                                            //                        for mono printers
