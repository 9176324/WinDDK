...
//
/////////////////////////////////////////////////////////////////////////
HRESULT CWssBasicDDI::GetApplicationOrderString(__deref_out_opt LPWSTR* ppwszKey)
{
    if (NULL == ppwszKey)
    {
        return E_INVALIDARG;
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnSetCurrentUser(__in const SID* pUser)
{
    HRESULT hr = S_OK;
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetCurrentUser(__out SID** ppUser)
{
    HRESULT hr = S_OK;
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnSetUserState(__in const SID* pUser,
...
__override HRESULT CWssBasicDDI::OnSetTime(__in const FILETIME time)
{
    (time);
...
__override HRESULT CWssBasicDDI::OnSetTimeZone(__in const SIDESHOW_TIME_ZONE_INFORMATION* pTimeZoneInformation)
{
...
__override HRESULT CWssBasicDDI::OnSetShortDateFormat(__in const SID*  user,
...
__override HRESULT CWssBasicDDI::OnSetLongDateFormat(__in const SID*  user,
                                                     __in LPCWSTR wszDateFormat)
{
    (user);
    (wszDateFormat);
...
__override HRESULT CWssBasicDDI::OnSetShortTimeFormat(__in const SID* user,
...
__override HRESULT CWssBasicDDI::OnSetLongTimeFormat(__in const SID* user,
                                                     __in LPCWSTR wszTimeFormat)
{
    (user);
    (wszTimeFormat);
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetDeviceFirmwareVersion(__deref_out_opt LPWSTR* pwszVersion)
{
    if (NULL == pwszVersion)
    {
        return E_POINTER;
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetDeviceManufacturer(__deref_out_opt LPWSTR* pwszManufacturer)
{
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetDeviceName(__deref_out_opt LPWSTR* pwszName)
{
    if (NULL == pwszName)
    {
        return E_POINTER;
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetDeviceEndpoints(__deref_out_opt ENDPOINT_ID** rgEndpoints,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetDeviceCapabilities(__in const PROPERTYKEY* pKey,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetApplicationOrder(__deref_out_opt APPLICATION_ID** ppAppIds,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnSetApplicationOrder(__in_ecount(cApps) const APPLICATION_ID* pApps,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnGetPreEnabledApplications(__deref_ecount(*pcApplications) APPLICATION_ID** ppAppIds,
                                                             __deref_ecount(*pcApplications) ENDPOINT_ID** ppEndpointIds,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnAddApplication(__in const SID* user,
                                                  __in REFAPPLICATION_ID rAppId,
                                                  __in REFENDPOINT_ID rEndPoint,
                                                  __in LPCWSTR wszName,
                                                  __in const DWORD dwCachePolicy,
...
__override HRESULT CWssBasicDDI::OnRemoveApplication(__in const SID* user,
                                                     __in REFAPPLICATION_ID rAppId)
{
    (user);
...
__override HRESULT CWssBasicDDI::OnRemoveAllApplications(__in const SID* user)
{
    (user);
...
__override HRESULT CWssBasicDDI::OnSetNotificationsEnabled(__in const SID* user,
...
//        E_OUTOFMEMORY : Couldn't allocate the necessary memory
__override HRESULT CWssBasicDDI::OnAddNotification(__in const SID* user,
                                                   __in REFAPPLICATION_ID rAppId,
...
__override HRESULT CWssBasicDDI::OnRemoveNotification(__in const SID* user,
                                                      __in REFAPPLICATION_ID rAppId,
                                                      __in const NOTIFICATION_ID notificationId)
{
    (user);
...
__override HRESULT CWssBasicDDI::OnRemoveAllNotifications(__in const SID* user,
                                                          __in REFAPPLICATION_ID rAppId)
{
    (user);
...
__override HRESULT CWssBasicDDI::OnAddContent(__in const SID* user,
                                              __in REFAPPLICATION_ID rAppId,
                                              __in REFENDPOINT_ID rRendererId,
                                              __in const CONTENT_ID contentId,
                                              __in_bcount_opt(cbData) const unsigned char* pData, // This is UTF8 data
...
__override HRESULT CWssBasicDDI::OnRemoveContent(__in const SID* user,
                                                 __in REFAPPLICATION_ID rAppId,
                                                 __in REFENDPOINT_ID rRendererId,
                                                 __in const CONTENT_ID contentId)
{
...
__override HRESULT CWssBasicDDI::OnRemoveAllContent(__in const SID* user,
                                                    __in REFAPPLICATION_ID rAppId,
                                                    __in REFENDPOINT_ID rRendererId)
{
    (user);
...
__override HRESULT CWssBasicDDI::OnProcessWpdMessage(__in IUnknown* pinValues,
...
//
/////////////////////////////////////////////////////////////////////////
__override HRESULT CWssBasicDDI::OnSetLanguage(__in const SID*  user,
