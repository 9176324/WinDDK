...
CNodeApplication::CNodeApplication(GUID guidApplicationId,
                                   __in_opt __drv_aliasesMem wchar_t* wszTitle,
                                   size_t SizeOfTitle,
...
CNodeNotification::CNodeNotification(GUID guidApplicationId,
                                     ...
                                     __in_ecount(SizeOfTitle) __drv_aliasesMem wchar_t* wszTitle,
                                     size_t SizeOfTitle,
                                     __in_ecount(SizeOfBody) __drv_aliasesMem wchar_t* wszBody,
                                     size_t SizeOfBody,
                                     HICON* pIcon,
                                     size_t SizeOfIcon,
...
CNodeDefaultBackground::CNodeDefaultBackground(__in_ecount(SizeOfTitle) __drv_aliasesMem wchar_t* wszTitle,
                                               size_t SizeOfTitle,
                                               __in_ecount(SizeOfBody) __drv_aliasesMem wchar_t* wszBody,
                                               size_t SizeOfBody,
                                               __drv_aliasesMem HICON* pIcon,
