...
--*/
{
    ...
    status = ScratchBuffer_ExecuteCdbEx(DeviceExtension, NULL, transferSize, FALSE, &cdb, 10, DeviceExtension->TimeOutValue * 4);
...
--*/
{
    ...
    ASSERT(!DeviceExtension->PowerContext.InUse);
