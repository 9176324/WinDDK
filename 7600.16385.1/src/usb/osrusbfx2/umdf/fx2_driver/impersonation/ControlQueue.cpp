...
--*/
{
    ...
    switch (ControlCode)
    {
        ...
        //
        // Continuos reader on interrupt pipe is no longer supported, so we do
        // not handle interrupt messages from the switch.
        //
        // WinUSB does not allow us to reset or re-enumerate the device.
        //
        // Return not-supported for the error in all these cases.
        //
