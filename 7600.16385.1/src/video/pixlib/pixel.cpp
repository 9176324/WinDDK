                               ...
                               D3DFORMAT       Format)
{
    ...
    BOOL retval = ComputeMipMapSizeChecked(cpWidth, cpHeight, cLevels, Format, &uSize);
    DXGASSERT(retval);
    return uSize;
} // ComputeMipMapSize
                                  ...
                                  D3DFORMAT    Format)
{
    ...
    BOOL retval = ComputeMipVolumeSizeChecked(cpWidth, cpHeight, cpDepth, cLevels, Format, &uSize);
    DXGASSERT(retval);
    return uSize;
