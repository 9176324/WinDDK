        ...
        case WM_NOTIFY:
            {
                ...
                if ( lpnmh -> code == PSN_APPLY ) {
                    ...
                    if (psdi && g_pSti) {
                        ...
                        //
                        // Use LocalAlloc to save on stack space.
                        //
                        TCHAR *pszPath  = (TCHAR*) LocalAlloc(LPTR, sizeof(TCHAR)*MAX_PATH);
                        WCHAR *pwszPath = (WCHAR*) LocalAlloc(LPTR, sizeof(WCHAR)*MAX_PATH); 
                        ...
                        {    
                            ...
                            GetWindowText(GetDlgItem(hwnd,IDC_EDIT_PATH),pszPath,MAX_PATH);
                            ...
                            if (*pszPath) {
                                ...
                                MultiByteToWideChar(CP_ACP, 0,
                                                    ...
                                                    pwszPath,MAX_PATH);
#else
                                StringCchCopy(pwszPath,MAX_PATH,pszPath);
#endif

                                psdiNew->pszPortName = pwszPath;
