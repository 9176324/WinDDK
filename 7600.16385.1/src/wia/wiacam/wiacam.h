...
public:
    ...
    STDMETHODIMP drvGetDeviceErrorStr(LONG lFlags, LONG lDevErrVal, __deref_out_opt LPOLESTR *ppszDevErrStr, LONG *plDevErrVal);
...
private:
    ...
    HRESULT GetOLESTRResourceString(LONG lResourceID, __deref_out LPOLESTR *ppsz);
    ...
    HRESULT ConstructFullName(MCAM_ITEM_INFO *pItemInfo, __out_ecount(cchFullNameSize) WCHAR *pwszFullName, INT cchFullNameSize);
