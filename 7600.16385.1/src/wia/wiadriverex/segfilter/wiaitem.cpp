 ...
 * 
 *****************************************************************************/
HRESULT CWiaItem::SetIWiaItem(__in IWiaItem2 *pIWiaItem)
{
    if (!pIWiaItem)
    {
        return E_INVALIDARG;
 ...
 * 
 *****************************************************************************/
HRESULT CWiaItem::ReadPropertyLong(PROPID PropertyID, __out LONG *plPropertyValue)
{
    if (!plPropertyValue)
    {
        return E_INVALIDARG;
 ...
 * 
 *****************************************************************************/
HRESULT CWiaItem::ReadPropertyGUID(PROPID PropertyID, __out GUID *pguidPropertyValue)
{
 ...
 * 
 *****************************************************************************/
HRESULT CWiaItem::ReadPropertyBSTR(PROPID PropertyID, __out BSTR *pbstrPropertyValue)
{
