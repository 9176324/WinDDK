...
// MEMSIC PACKET FORMAT:   [ SENSOR_ID = 6      | ELEMENT_COUNT = 1      | ELEMENT_SIZE = 8      | X-Axis Gs 4-bytes |  Y-Axis Gs 4-bytes | INTERVAL (5 bytes) ]
...
#define MEMSIC_DATA_LENGTH          11  // count of data bytes for MEMSIC dual-axis accelerometer
