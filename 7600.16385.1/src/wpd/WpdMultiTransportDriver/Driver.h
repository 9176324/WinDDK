...
class ATL_NO_VTABLE CDriver :
    ...
    public CComCoClass<CDriver, &CLSID_WpdMultiTransportDriver>,
    public IDriverEntry,
...
public:
    ...
    DECLARE_REGISTRY_RESOURCEID(IDR_WpdMultiTransportDriver)
...
OBJECT_ENTRY_AUTO(__uuidof(WpdMultiTransportDriver), CDriver)
