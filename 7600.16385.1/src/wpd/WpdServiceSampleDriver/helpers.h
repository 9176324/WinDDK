...
public: // Context accessor methods
    ...
    // a context key
    HRESULT Add(
        __in    IUnknown*     pContext,
        __out   CAtlStringW&  key)
    {
        CComCritSecLock<CComAutoCriticalSection> Lock(m_CriticalSection);
        HRESULT  hr          = S_OK;
...
public:
    ...
    PropVariantWrapper& operator= (__in LPCWSTR pszSrc)
    {
        Clear();
    ...
    PropVariantWrapper& operator= (__in IUnknown* punkSrc)
    {
        Clear();
...
HRESULT UpdateDeviceFriendlyName(
    __in    IPortableDeviceClassExtension*  pPortableDeviceClassExtension,
    __in    LPCWSTR                         wszDeviceFriendlyName);
...
HRESULT SetPropertyAttributes(
                                REFPROPERTYKEY                  Key,
   __in_ecount(cAttributeInfo)  const PropertyAttributeInfo*    AttributeInfo,
    __in                        DWORD                           cAttributeInfo,
    __out                       IPortableDeviceValues*          pAttributes);

HRESULT SetMethodParameterAttributes(
                                REFPROPERTYKEY                          Parameter,
    __in_ecount(cAttributeInfo) const  MethodParameterAttributeInfo*    AttributeInfo,
    __in                        DWORD                                   cAttributeInfo,
    __out                       IPortableDeviceValues*                  pAttributes);

HRESULT SetEventParameterAttributes(
                                REFPROPERTYKEY                      Parameter,
    __in_ecount(cAttributeInfo) const EventParameterAttributeInfo*  AttributeInfo,
    __in                        DWORD                               cAttributeInfo,
    __out                       IPortableDeviceValues*              pAttributes);
...
HRESULT SetEventParameters(
    ...
    __in_ecount(cAttributeInfo) const EventParameterAttributeInfo*  AttributeInfo,
    __in                        DWORD                               cAttributeInfo,
    __out                       IPortableDeviceKeyCollection*       pParameters);
